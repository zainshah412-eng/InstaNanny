...
public class ApplyFont {
    ...
    public final static String FONT_TYPEFACE = "CircularStd-Book.ttf";
    public final static String FONT_SEMIBOLDTYPEFACE = "CircularStd-Bold.ttf";
    public final static String FONT_TYPEFACE_Bold = "CircularStd-Black.ttf";
    public final static String FONT_TYPEFACE_LIGHT = "CircularStd-Book.ttf";
