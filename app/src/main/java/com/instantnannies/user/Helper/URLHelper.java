...
public class URLHelper {
    public static final String base = "https://app.instantnannies.com/";
    public static final int client_id = 12;  // server side passport credentials 8bc8PVqMI5Yhjv6Tsi87gJ5pqQw0JgirSkx0F9SG
    public static final String client_secret = "NdBUUyob1gu7f4k4XfW6CehgWqwyOJyvCyi0Rs6e";   // server side passport credentials
    public static final String STRIPE_TOKEN = "pk_test_H3WeOoXLZ6Kk0FJtUocyc73c000dxVX4Fp";
