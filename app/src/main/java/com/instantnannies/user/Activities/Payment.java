...
import com.instantnannies.user.Adapters.NewPaymentListAdapter;
...
/*
    ...
    public void findViewByIdAndInitialize() {
        addCard = (CustomBoldTextView) findViewById(R.id.addCard);
        payment_list_view = (ListView) findViewById(R.id.payment_list_view);
        empty_text = (CustomBoldTextView) findViewById(R.id.empty_text);
